            ...
            <div>
              <Link href="/" aria-label="email association">
                <a target="_blank" rel="noopener" className='flex justify-center items-center'>
                  ...
                  <p className=" flex flex-col justify-center w-5/6 p-1 items-center bg-gradient-to-b from-blue-700 via-blue-800 to-red-500   rounded-xl m-2  text-white  ">Assosuffrage@gmail.com</p>
                </a>
              ...
              <Link href="/" aria-label="email association">
                <a target="_blank" rel="noopener" className='flex justify-center items-center'>
                  ...
                  <p className=" flex flex-col justify-center w-5/6 p-1 items-center bg-gradient-to-b from-blue-700 via-blue-800 to-red-500   rounded-xl m-2  text-white  ">Assosuffrage@twitter.com</p>
                </a>
              ...
              <Link href="/" aria-label="email association">
                <a target="_blank" rel="noopener" className='flex  items-center'>
                  ...
                  <p className=" flex flex-col justify-center w-5/6 p-1 items-center bg-gradient-to-b from-blue-700 via-blue-800 to-red-500   rounded-xl m-2  text-white  ">Assosuffrage@facebook.com</p>
                </a>
              ...
              <Link href="/" aria-label="email association">
                <a target="_blank" rel="noopener" className='flex items-center'>
                  ...
                  <p className=" flex flex-col justify-center w-5/6 p-1 items-center bg-gradient-to-b from-blue-700 via-blue-800 to-red-500   rounded-xl m-2  text-white  ">Assosuffrage@instagram.com</p>
                </a>
              ...
              <Link href="/" aria-label="email association">
                <a target="_blank" rel="noopener" className='flex  items-center'>
                  ...
                  <p className=" flex flex-col justify-center p-1 w-5/6 items-center bg-gradient-to-b from-blue-700 via-blue-800 to-red-500   rounded-xl m-2  text-white  ">Assosuffrage@linkedin.com</p>
                </a>
